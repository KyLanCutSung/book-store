package com.mingming.bookservice.query.controller;
...
public class BookQueryController {
    ...
    public BookResponseModel getBookDetail(@PathVariable String bookId){
        ...
        BookResponseModel bookResponseModel = queryGateway.query(getBooksQuery, ResponseTypes.instanceOf(BookResponseModel.class))
                .join();
